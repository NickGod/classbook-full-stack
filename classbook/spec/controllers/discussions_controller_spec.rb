  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved discussion as @discussion" do
        post :create, {:discussion => invalid_attributes}, valid_session
        expect(assigns(:discussion)).to be_a_new(Discussion)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested discussion" do
        discussion = Discussion.create! valid_attributes
        put :update, {:id => discussion.to_param, :discussion => new_attributes}, valid_session
        discussion.reload
    ...
    context "with invalid params" do
      it "assigns the discussion as @discussion" do
        discussion = Discussion.create! valid_attributes
        put :update, {:id => discussion.to_param, :discussion => invalid_attributes}, valid_session
        expect(assigns(:discussion)).to eq(discussion)
      end
